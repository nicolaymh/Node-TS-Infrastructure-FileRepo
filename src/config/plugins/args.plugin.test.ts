...
describe('Test args.plugin.ts', () => {
    ...
    test('should return default values', () => {
        ...
        const argv = runCommand(['node', 'test', '-b', '5']);
    ...
    test('should return configuration with custom values', () => {
        ...
        const argv = runCommand(['node', 'test', '-b', '10', '-l', '20', '-s', 'true', '-n', 'table', '-d', 'files']);
    ...
    test('should throw error if the base is less than 1 using yargs', () => {
        ...
        expect(() => runCommand(['node', 'test', '-b', '0'])).toThrow('The base must be greater than 0');
